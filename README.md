...
- 🎯 **Current Focus**: Enhancing my Kotlin and Flutter skills and expanding my Mobile Application Development expertise, particularly with Android Application Development.
- 💼 **Current Role**: Sr. Android Developer @ Biz Insights IT Solution LLP, Surat
- 🌱 **Learning**: Exploring Kotlin and advanced Android development practices.
- 🎯 **Interested In**: Mobile Application Development, Photography.

## 🛠️ Technologies & Tools

- **Languages**: Java, Kotlin (beginner), Flutter/Dart (beginner)
- **Frameworks**: Android SDK, Firebase, Retrofit
- **Tools**: Android Studio, Git, Gradle, Postman
- **Databases**: SQLite, Firebase Realtime Database
- **Version Control**: Git, GitHub
- **APIs**: RESTful APIs, Google Play Services
...
| **Hall Booking System** | A solution to manage bookings and availability for event halls.     | Private Project |
| **Home Automation** | A solution to control home appliances remotely via a mobile app.        | Private Project |

## 📊 Stats

![Your GitHub Stats](https://github-readme-stats.vercel.app/api?username=SagarBChauhan&show_icons=true&theme=dark)
[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=SagarBChauhan&layout=donut&theme=dark)](https://github.com/anuraghazra/github-readme-stats)

## 🔗 Let's Connect

- LinkedIn: [sagarkumarchauhan](https://www.linkedin.com/in/sagarkumarchauhan)
- Twitter: [@imrsaggy](https://twitter.com/imrsaggy)
- Portfolio: [Portfolio](https://sagarbchauhan.github.io)
